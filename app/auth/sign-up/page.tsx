    ...
    <div className="w-full max-w-md mx-auto space-y-8 p-6">
      ...
      <div className="flex flex-col space-y-2">
        <button
          ...
          className="flex items-center justify-center gap-2 h-10 border border-input rounded-md px-3 text-sm font-medium"
        >
          <svg viewBox="0 0 24 24" width="16" height="16" className="text-[#4285F4]">
            <path
              fill="currentColor"
